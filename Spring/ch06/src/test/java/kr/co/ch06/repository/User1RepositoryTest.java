...
class User1RepositoryTest {
    ...
    @Test
    void findUser1ById() {
        User1 user1 = user1Repository.findUser1ByUserid("abc3532");
        System.out.println(user1);
    }

    @Test
    void findUser1ByName() {
        List<User1> list = user1Repository.findUser1ByName("김석삼");
    ...
    void selectParentJoinChild() {
        Parent parent = Parent.builder().pid("p101").name("김유신").age(12).build();
        parentRepository.save(parent);
        Child child = Child.builder().cid("c101").pid("p101").name("김철수").age(12).build();
        childRepository.save(child);

        user1Repository.selectParentJoinChild("p101");

        List<Object[]> selectparent = user1Repository.selectParentJoinChild("p101");
